            ...
            <form class="s-text" action="proses.php" method="POST">
                <div class="row mb-3">
                  ...
                  <div class="col-sm-3 pt-1">
                    <input type="text" class="form-control form-control-sm" name="kodepenyakit" id="kodepenyakit" placeholder="Contoh : P0xx" required>
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="namapenyakit" class="col-sm-3 col-form-label">Nama Penyakit</label>
                  <div class="col-sm-6 pt-1">
                    <input type="text" class="form-control form-control-sm" name="namapenyakit" id="namapenyakit" required>
                  </div>
                </div>
                <div class="row mb-3">
                    <label for="pengobatan" class="col-sm-3 col-form-label">Pengobatan</label>
                    <div class="col-sm-8 pt-1">
                      <textarea name="pengobatan" id="pengobatan" cols="10" rows="3" class="form-control form-control-sm"></textarea>
                    </div>
                </div>

            ...
            <form class="s-text" action="proses.php" method="POST">
                <div class="row mb-3">
                  ...
                  <div class="col-sm-3 pt-1">
                    <input type="text" class="form-control form-control-sm" name="kodegejala" id="kodegejala" placeholder="Contoh : G0xx" required>
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="namagejala" class="col-sm-3 col-form-label">Nama Gejala</label>
                  <div class="col-sm-6 pt-1">
                    <input type="text" class="form-control form-control-sm" name="namagejala" id="namagejala" required>
                  </div>
                </div>
                <div class="row mb-3">
                    <label for="nilai" class="col-sm-3 col-form-label">Nilai Gejala</label>
                    <div class="col-sm-2 pt-1">
                      <input type="text" class="form-control form-control-sm" id="nilai" name="nilai" required>
                    </div>
                </div>
                <div class="row mb-3">
